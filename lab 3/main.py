...
cur.execute("""
SELECT *
FROM (SELECT ARTIST_ID, ARTIST_NAME, COUNT(ARTIST_ARTWORK.ARTWORK_ID) ARTWORKS_COUNT
      FROM ARTIST_ARTWORK
...
cur.execute("""
SELECT PROC_OFFICER_NAME, COUNT(ARTWORK_ID) ARTWORKS_CREDITED_COUNT
FROM PROC_OFFICER_ARTWORK
GROUP BY PROC_OFFICER_NAME
